...
class eccDefinition:
    ...
    def measure_ecc(self, tref_in=None, fref_in=None):
        ...
        phases in the coprecessing frame.

        Throughout this documentation, we will refer to omega_gw and
        amp_gw. For nonprecessing systems, these quantities reduce to the
        corresponding values obtained using the (2, 2) mode, i. e., for
