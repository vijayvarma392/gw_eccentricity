...
def get_data_dict(params, data_dict_generator,
    ...
    data_dict_generator : function
        data_dict is generated using function call as below::
            ...
            data_dict = data_dict_generator(params, data_dict_generator_kwargs)
    ...
    """
    if data_dict_generator_kwargs is None:
        data_dict_generator_kwargs = {}
    data_dict = data_dict_generator(
        params, data_dict_generator_kwargs)
...
def get_fref_bounds_for_sample(
    ...
    try:
        data_dict = get_data_dict(params, data_dict_generator, data_dict_generator_kwargs)
        ...
        warn(f"Sample {params} failed to get fref bounds: {exception_message}")
        res_dict.update({
            "status": "fail",
            "fref_min": None,
            "fref_max": None,
...
def measure_eccentricity_for_sample(
        params,
        fref,
        data_dict_generator,
        data_dict_generator_kwargs=None,
    ...
    try:
        ...
        warn(f"Sample {params} failed: {exception_message}")
        res_dict.update({
            "status": "fail",
            "eccentricity": None,
            "mean_anomaly": None,
...
class PostProcess:
    ...
    def __init__(self, posterior_file, data_dict_generator,
        ...
        data_dict_generator : function
            ...
            - `sample_params` is dict containing the parameters for a sample in
              the posterior.
            - `data_dict_generator_kwargs` is an optional dict of parameters to
    ...
    def get_injection_data_dict(self):
        ...
        data_dict = get_data_dict(
            ...
            data_dict_generator_kwargs=self.data_dict_generator_kwargs)
        return data_dict
    ...
    def post_process(self, fref, samples=None, method="Amplitude",
        ...
        self.post_process_result = Parallel(
            ...
            delayed(measure_eccentricity_for_sample)(
                params, fref, data_dict_generator, data_dict_generator_kwargs,
                method, gw_eccentricity_kwargs
            )
            for params in tqdm(param_list, desc="Post-processing samples")
        )
    ...
    def get_fref_bounds(self, samples=None, method="Amplitude",
        ...
        results = Parallel(
            ...
            delayed(get_fref_bounds_for_sample)(
                param, data_dict_generator, data_dict_generator_kwargs,
                method, gw_eccentricity_kwargs)
